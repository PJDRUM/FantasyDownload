...
def parse_adp_value(raw_value: object) -> float | None:
    ...
    # FantasyPros sometimes appends the movement delta to the Real-Time cell,
    # like "38 -8" or "50 +14". We only want the first number.
